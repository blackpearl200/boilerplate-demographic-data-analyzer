...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_percentage = ((df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts()).sort_values(ascending=False)[0] * 100).round(1)
